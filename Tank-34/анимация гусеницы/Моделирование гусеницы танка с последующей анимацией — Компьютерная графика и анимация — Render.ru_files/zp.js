...
if (window["__utl_retransmitted"]===undefined) {
    ...
    var EventSender = Sender.inherit({
        ...
        sendClickLink: function (url, text, options) {
            ...
            this._hitExt(url, text, win.document.location.href, null, options)
        },
    ...
    function sendClick(event) {
        ...
        if (target) {
            ...
            if (tagName==='A' && localDomain!==hostname && href.search(/^https?:/i)>=0) {
                iframe.contentWindow.postMessage({action: "store_link", event: {href: href, text: text, params: {pid: options.pid, viewId: viewId, ref: localHref}}}, "*");
    ...
    var localDomain = win.document.location.hostname;
    var localHref = win.document.location.href;
    ...
    var eventSender = new EventSender({
        protocol: win.document.location.protocol,
        host: options.host,
        counterType: "zp",
        resource: options.clk
    });
...
if (!window["__utl__ext__counters"]) {
    ...
    (function() {
        var _gaq = _gaq || [];
        _gaq.push(['_setAccount', 'UA-46571442-1']);
        _gaq.push(['_setDomainName', 'uptolike.ru']);
...
(function() {
    ...
    ready(function() {
        ...
        iframe.src = "//"+options.host+options.support+"?1";
        ...
        attachEvent(win.document, "click", function(event) {
            sendClick(event);
        });
